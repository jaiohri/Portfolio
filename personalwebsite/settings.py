...
SECRET_KEY = config('SECRET_KEY', default='django-insecure-&%us*3@6nk4=s*_&$zzb*r8(qlpw27tkcrqq(ainwcakxtlq3!')

# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = config('DEBUG', default=True, cast=bool)

ALLOWED_HOSTS = config('ALLOWED_HOSTS', default='localhost,127.0.0.1,portfolio-5mup.onrender.com', cast=lambda v: [s.strip() for s in v.split(',') if s.strip()])
...
MIDDLEWARE = [
    ...
    'pages.middleware.AutoGuestLoginMiddleware',  # Auto-login guests
